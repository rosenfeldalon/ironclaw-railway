...
CALENDAR_TAG="${SIMON_CALENDAR_EXTENSION_TAG:-ironclaw-simon-telegram-durable-workspace-2026-05-06}"
...
install_bundle \
  ...
  wasm_channel \
  "${RAW_BASE}/${CALENDAR_TAG}/bundles/simon_telegram_channel/1.16.tar.gz"
